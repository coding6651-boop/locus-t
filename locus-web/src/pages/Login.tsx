    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative">
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-1 text-xs text-black/40">Sign in to your account</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-5 sm:p-6">
          <form onSubmit={(e) => { e.preventDefault(); navigate("/dashboard"); }} className="space-y-3.5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-3.5 h-3.5 rounded border-black/20 accent-black" />
                <span className="text-xs text-black/40">Remember me</span>
              </label>
              <a href="#" className="text-xs text-black/50 hover:text-black transition-colors">
                Forgot password?
              </a>
            </div>
          ...
          <button
            ...
            className="w-full mt-3 bg-white/50 border border-black/8 text-black/60 py-2.5 rounded-xl text-sm font-medium transition-all hover:bg-white/70 active:scale-[0.98]"
          >
            Continue as Guest
          </button>
        </div>
